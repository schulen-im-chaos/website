...
<svelte:head>
	...
	<meta name="description" content="Willkommen auf der Homepage von Schulen im Chaos!" />
</svelte:head>

<HeadingMain>Willkommen auf der Homepage von Schulen im Chaos!</HeadingMain>
