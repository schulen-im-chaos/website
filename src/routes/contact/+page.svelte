...
<div class="w-full max-w-3xl pb-4 px-2 text-sm">
	<Alert bind:hidden={successHidden} hrefOnClose="/" color="red">
	...
	<Alert bind:hidden={alertHidden} hrefOnClose="/" color="blue">
...
<form class="px-2 max-w-3xl" id="message-form" on:submit={handleSubmit}>
	...
	<div class="w-full p-2 text-center">
		Schreibe uns eine E-Mail an <Link href="mailto:{CONTACT_EMAIL}">{CONTACT_EMAIL}</Link>.
	</div>
</form>
