...
{#if $page.status == 404 || $page.status == 200}
	<ParagraphDefault
		>Wir können die Seite, die du angefragt hast, nirgendwo finden, nicht mal im Schulkeller :(</ParagraphDefault
	>
{:else}
	<ParagraphDefault
		>Es ist etwas schiefgelaufen, wo nicht mal wir selber wissen, was es sein könnte :(</ParagraphDefault
	>
	<ParagraphDefault
...
<div class="p-2 md:mt-16 md:mb-32">
	{#if $page.status == 200}
